...
public sealed class Localizer : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> Chinese = new(StringComparer.Ordinal)
    {
        ...
        ["Spatial.Dir.6"] = "正左方",
        ["Spatial.Dir.7"] = "左前方",
        ["Spatial.Tip"] = "这台设备相对你的方位。八台设备距离都一样，所以方位只改变左右声像，不额外增加延迟。默认正前方，效果等同于不设方位。",
        ["Volume.Label"] = "设备音量",
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["Spatial.Tip"] = "Where this device sits relative to you. Every direction is the same distance away, so this only pans the stereo image and never adds delay. The default, straight ahead, changes nothing.",
