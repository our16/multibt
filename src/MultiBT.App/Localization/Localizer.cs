...
public sealed class Localizer : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> Chinese = new(StringComparer.Ordinal)
    {
        ...
        ["Spatial.Dir.6"] = "正左",
        ["Spatial.Dir.7"] = "左前",
        ["Spatial.Suffix.Level"] = "方",
        ["Spatial.Suffix.Above"] = "上方",
        ["Spatial.Suffix.Below"] = "下方",
        ["Spatial.Zenith"] = "正上方",
        ["Spatial.Nadir"] = "正下方",
        ["Spatial.Elev.Up"] = "正上",
        ["Spatial.Elev.High"] = "斜上 45°",
        ["Spatial.Elev.Level"] = "水平",
        ["Spatial.Elev.Low"] = "斜下 45°",
        ["Spatial.Elev.Down"] = "正下",
        ["Spatial.Hint"] = "点或拖球面放置；拖球外的空白处旋转视角，滚轮缩放。",
        ["Spatial.View.Reset"] = "重置视角",
        ["Spatial.Close"] = "关闭",
        ["Spatial.Distance.Label"] = "距离",
        ["Spatial.Distance.Tip"] = "这台设备离你多远。只有打开「距离生效」，它才会影响声音。",
        ["Spatial.UseDistance"] = "距离生效",
        ["Spatial.UseDistance.Tip"] = "打开后：更远的设备会被延迟，好让它和近的设备同时到达，并按距离轻微衰减。关闭时距离被忽略，只有方位改变左右声像。",
        ["Spatial.Readout.Channels"] = "声像 L {0} / R {1}",
        ["Spatial.Readout.Delay"] = "距离延迟 {0} ms",
        ["Spatial.Readout.Attenuation"] = "衰减 {0} dB",
        ["Spatial.Readout.Passive"] = "距离未生效：方位只改变左右声像。",
        ["Spatial.Tip"] = "这台设备相对你的方位。点球面直接放位置，或用下面的预设精确设定；距离默认 1 米。",
        ["Volume.Label"] = "设备音量",
        ...
        ["Diagnostics.None"] = "—",
        ["Diagnostics.Verdict.None"] = "链路侧：没有设备在输出。",
        ["Diagnostics.Verdict.Endpoint"] = "链路侧：某台设备没有稳定取数 → 断续发生在该设备或它的链路上，不在本程序。",
        ["Diagnostics.Verdict.SharedSource"] = "链路侧：多台设备同时欠载 → 共享环节（捕获源）的问题，不是某台设备。",
        ["Diagnostics.Verdict.SingleDevice"] = "链路侧：只有一台设备欠载 → 该设备自己的取数问题，其他设备不受影响。",
        ["Diagnostics.Verdict.ClockMismatch"] = "链路侧：漂移修正已顶在上限 → 该设备的时钟偏差超出本程序的纠偏权限。",
        ["Diagnostics.Verdict.Backlog"] = "链路侧：环形队列在堆积 → 缓冲高于目标且被反复裁剪；每次裁剪都会丢音频（就是断续），各设备还停在不同的深度上（于是先后到达）。这是本程序这条链路的速率问题，不是设备或链路。",
        ["Diagnostics.Verdict.Delivered"] = "链路侧：无异常 → 数据已正常交付到每台设备；若有断续，发生在设备内部或链路上，不在这条链路里。",
        ...
        ["Status.DefaultRestoredAfterCrash"] = "上次没有正常退出，已把 Windows 默认输出设备还原为「{0}」。",
        ["Sink.Label"] = "音频输入",
        ...
        ["Status.DeviceStopped"] = "已停止",
        ["Status.DeviceSkippedSource"] = "已跳过（捕获源）",
        ["Status.Running"] = "运行中",
        ["Status.Delay"] = "延迟 {0} ms",
        ["Status.Resynced"] = "已重同步",
        ["Status.Failed"] = "失败",
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["Master.Label"] = "Master",
        ["Spatial.Label"] = "Position",
        ["Spatial.Listener"] = "you",
        ["Spatial.Dir.0"] = "ahead",
        ["Spatial.Dir.1"] = "front right",
        ["Spatial.Dir.2"] = "right",
        ["Spatial.Dir.3"] = "behind right",
        ["Spatial.Dir.4"] = "behind",
        ["Spatial.Dir.5"] = "behind left",
        ["Spatial.Dir.6"] = "left",
        ["Spatial.Dir.7"] = "front left",
        ["Spatial.Suffix.Level"] = "",
        ["Spatial.Suffix.Above"] = " above",
        ["Spatial.Suffix.Below"] = " below",
        ["Spatial.Zenith"] = "straight up",
        ["Spatial.Nadir"] = "straight down",
        ["Spatial.Elev.Up"] = "up",
        ["Spatial.Elev.High"] = "45° up",
        ["Spatial.Elev.Level"] = "level",
        ["Spatial.Elev.Low"] = "45° down",
        ["Spatial.Elev.Down"] = "down",
        ["Spatial.Hint"] = "Click or drag the sphere to place it; drag the space around it to turn the view, wheel to zoom.",
        ["Spatial.View.Reset"] = "Reset view",
        ["Spatial.Close"] = "Close",
        ["Spatial.Distance.Label"] = "Distance",
        ["Spatial.Distance.Tip"] = "How far away this device is. It only changes the sound when \"Distance counts\" is on.",
        ["Spatial.UseDistance"] = "Distance counts",
        ["Spatial.UseDistance.Tip"] = "On, a farther device is held back so it arrives with the nearer ones, and is gently lowered with distance. Off, the distance is ignored and only the direction moves the stereo image.",
        ["Spatial.Readout.Channels"] = "image L {0} / R {1}",
        ["Spatial.Readout.Delay"] = "distance delay {0} ms",
        ["Spatial.Readout.Attenuation"] = "attenuation {0} dB",
        ["Spatial.Readout.Passive"] = "distance ignored: a direction only moves the stereo image.",
        ["Spatial.Tip"] = "Where this device sits relative to you. Click the sphere to place it, or use the presets below for an exact direction. The distance starts at one metre.",
        ...
        ["Diagnostics.None"] = "—",
        ["Diagnostics.Verdict.None"] = "chain: no device is playing out.",
        ["Diagnostics.Verdict.Endpoint"] = "chain: a device is not taking data steadily — the interruption is on that device or its link, not in this program.",
        ["Diagnostics.Verdict.SharedSource"] = "chain: several devices are starving at once — that is the shared capture source, not one device.",
        ["Diagnostics.Verdict.SingleDevice"] = "chain: one device is starving while the others are fine — that device's own read rate.",
        ["Diagnostics.Verdict.ClockMismatch"] = "chain: the drift correction is pinned at its ceiling — that device's clock differs by more than this program may correct.",
        ["Diagnostics.Verdict.Backlog"] = "chain: the rings are backing up — the fill sits above the target and keeps being cut back; every cut drops audio (that is the choppiness), and devices left at different depths arrive at different times. This is a rate problem in this program's own chain, not the device or its link.",
        ["Diagnostics.Verdict.Delivered"] = "chain: nothing is wrong — data is reaching every device; any choppiness is inside a device or on its link, not in this chain.",
        ...
        ["Status.DefaultRestoredAfterCrash"] = "The last run did not exit cleanly, so the Windows default output was put back to \"{0}\".",
